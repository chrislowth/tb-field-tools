...
# Originally from:
#   https://raw.githubusercontent.com/andrew-d/static-binaries/master/nano/build.sh
...
function build_ncurses() {
    ...
    # Download
    # curl -LO ftp://ftp.invisible-island.net/ncurses/ncurses-${NCURSES_VERSION}.tar.gz
